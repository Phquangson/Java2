...
public class JPanelAddCategory extends JPanel {
	...
	public JPanelAddCategory(JPanelCategory parent) {
		this.parent = parent;
		initUI();
	}
	...
	private void initUI() {
		...
		lblTitle = new JLabel("Add Category", SwingConstants.CENTER);
		...
		btnAdd.addActionListener(e -> {
			...
			if (!statusText.isEmpty()) {
				...
				JOptionPane.showMessageDialog(this, "Please enter a category before adding.");
			}
		});
	...
	public void setCategoryData(Category category) {
		txtStatus.setText(category.getTitle());
		...
		btnAdd.addActionListener(e -> {
			...
			if (!newTitle.isEmpty()) {
				CategoryModel model = new CategoryModel();
				if (model.update(category.getId(), newTitle)) {
	...
	private void enableDrag() {
		...
		addMouseMotionListener(new java.awt.event.MouseMotionAdapter() {
			...
			public void mouseDragged(java.awt.event.MouseEvent e) {
				Window window = SwingUtilities.getWindowAncestor(JPanelAddCategory.this);
				if (window != null) {
