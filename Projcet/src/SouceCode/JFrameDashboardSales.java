...
public class JFrameDashboardSales extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(() -> {
            try {
                ...
                JFrameDashboardSales frame = new JFrameDashboardSales();
    ...
    public JFrameDashboardSales() {
        ...
        // Các nút menu với icon đúng
        JButton btnDashboard = createMenuButton("Bill Creation", "/resources/icon-dashboard.png");
        JButton btnManageBill = createMenuButton("Manage Bill", "/resources/icon-bill.png"); // Icon bill
        JButton btnCustomerManagement = createMenuButton("Customer", "/resources/icon-customer.png"); // Icon customer
        JButton btnHelpGuide = createMenuButton("Help / Guide", "/resources/icon-help.png");
        JButton btnNotification = createMenuButton("Notification", "/resources/icon-notification.png");
        ...
        panel.add(btnManageBill);
        panel.add(btnCustomerManagement);
        panel.add(btnHelpGuide);
        ...
        // ===== ACTION CHO CÁC NÚT =====
        btnDashboard.addActionListener(e -> loadPanel(new JPanelSalesDashboard()));
        btnManageBill.addActionListener(e -> loadPanel(new JPanelManageBill()));
        btnCustomerManagement.addActionListener(e -> loadPanel(new JPanelCustomerManagement()));
        btnHelpGuide.addActionListener(e -> loadPanel(new JPanelHelpGuide()));
        btnNotification.addActionListener(e -> loadPanel(new JPanelNotificationSales()));
        btnChangePass.addActionListener(e -> loadPanel(new JPanelChangePass()));
        btnLogout.addActionListener(e -> logout());

        // ===== LOAD MẶC ĐỊNH =====
        loadPanel(new JPanelSalesDashboard());
    }
    ...
    private JButton createMenuButton(String text, String iconPath) {
        ...
        if (iconPath != null) {
            ...
            if (imgURL != null) {
                ...
                System.out.println("Icon not found: " + iconPath); // Debug nếu icon không load được
            }
        }
    ...
    private void logout() {
        int confirm = JOptionPane.showConfirmDialog(this, "Are you sure you want to log out?", "Sign out",
