...
public class JFrameDashboardSupperAdmin extends JFrame {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(() -> {
			try {
				...
				JFrameDashboardSupperAdmin frame = new JFrameDashboardSupperAdmin(staffLogin);
	 ...
	 * Create the frame.
	 */
	public JFrameDashboardSupperAdmin(Staff staff) {
...
//        panel.add(jbuttonStockOut);
		...
		JButton btnSetting = createMenuButton("Settings", "/resources/icon-edit.png");
